...
const TermsOfServices = () => {
  return (
    <div className={styles.Body}>
        <header className={styles.main_header +" " +styles.dark_theme}>

        <ul className={styles.header_options}>

            <li className={styles.option +" " +styles.title}> Serenity Seek </li>
            <li className={styles.option}><Link className={styles.Link} to="/">Home</Link></li>
            <li className={styles.option}><Link className={styles.Link} to="/Register">Signup</Link></li>
            <li className={styles.option}><Link className={styles.Link} to="/Login">Login</Link></li>
        </ul>

        </header>

        <header className={styles.header_mobile +" " +styles.dark_theme}>
            <h3 className={styles.title_mobile}> Serenity Seek </h3>
        </header>
        ...
        <footer>
            <p className={styles.footer_heading}>© Copyright 2023-2024 SerenitySeek. All rights reserved.</p>
        </footer>
